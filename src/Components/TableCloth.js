...
import product1 from "../Assets/Product-Specification/Tablecloth/Tablecloth (1).jpg";
import product2 from "../Assets/Product-Specification/Tablecloth/Tablecloth (2).jpg";
import product3 from "../Assets/Product-Specification/Tablecloth/Tablecloth (3).jpg";
import product4 from "../Assets/Product-Specification/Tablecloth/Tablecloth (4).jpg";
import product5 from "../Assets/Product-Specification/Tablecloth/Tablecloth (5).jpg";
